...
// //       <div className="pt-4">
// //         <p className="text-xs font-bold uppercase tracking-[0.35em] text-luxe-bronze">Guest Registration</p>
// //         <h1 className="mt-4 font-serif text-5xl leading-none sm:text-6xl">Create your hotel account</h1>
// //         <p className="mt-5 max-w-xl text-lg leading-8 text-luxe-muted">
// //           This form uses the real backend registration API. The account is created first, and the
// //           guest must verify the email link before login.
// //         </p>

// //         <div className="mt-8 rounded-[28px] border border-luxe-bronze/20 bg-white/80 p-6 shadow-[0_20px_50px_rgba(28,28,28,0.06)]">
// //           <span className="text-xs font-bold uppercase tracking-[0.28em] text-luxe-bronze">Real API Flow</span>
// //           <strong className="mt-3 block text-lg text-luxe-charcoal">Register, verify email, then login</strong>
// //           <p className="mt-3 text-sm leading-7 text-luxe-muted">
// //             Required: firstName, lastName, email, phone, password, confirmPassword. Optional:
// //             address and idProof.
// //           </p>
// //         </div>
// //       </div>
...
// //       >
// //         <div className="mb-6">
// //           <h2 className="font-serif text-3xl">Sign up</h2>
// //           <p className="mt-2 text-sm leading-7 text-luxe-muted">
// //             After submit, the backend sends a verification link to email.
// //           </p>
// //         </div>
...
// //             First name
// //             <input type="text" name="firstName" placeholder="Enter first name" value={formData.firstName} onChange={handleChange} className={fieldClass} />
// //           </label>
// //           <label className="block text-sm font-semibold text-luxe-charcoal">
// //             Last name
// //             <input type="text" name="lastName" placeholder="Enter last name" value={formData.lastName} onChange={handleChange} className={fieldClass} />
// //           </label>
// //           <label className="block text-sm font-semibold text-luxe-charcoal md:col-span-2">
// //             Email address
// //             <input type="email" name="email" placeholder="name@example.com" value={formData.email} onChange={handleChange} className={fieldClass} />
// //           </label>
// //           <label className="block text-sm font-semibold text-luxe-charcoal">
// //             Phone number
// //             <input type="text" name="phone" placeholder="Enter phone number" value={formData.phone} onChange={handleChange} className={fieldClass} />
// //           </label>
// //           <label className="block text-sm font-semibold text-luxe-charcoal">
// //             ID proof
// //             <input type="text" name="idProof" placeholder="Aadhaar, passport, driving licence" value={formData.idProof} onChange={handleChange} className={fieldClass} />
// //           </label>
// //           <label className="block text-sm font-semibold text-luxe-charcoal md:col-span-2">
// //             Address
// //             <input type="text" name="address" placeholder="Enter address" value={formData.address} onChange={handleChange} className={fieldClass} />
// //           </label>
// //           <label className="block text-sm font-semibold text-luxe-charcoal">
// //             Password
// //             <input type="password" name="password" placeholder="Create password" value={formData.password} onChange={handleChange} className={fieldClass} />
// //           </label>
// //           <label className="block text-sm font-semibold text-luxe-charcoal">
// //             Confirm password
// //             <input type="password" name="confirmPassword" placeholder="Confirm password" value={formData.confirmPassword} onChange={handleChange} className={fieldClass} />
// //           </label>
// //         </div>
...
// //             <span className="text-xs font-bold uppercase tracking-[0.28em] text-luxe-bronze">Next step</span>
// //             <strong className="mt-2 block text-lg">Verify your email</strong>
// //             <p className="mt-2 text-sm leading-7 text-luxe-muted">
// //               The account for <strong>{submittedEmail}</strong> has been registered. The user must
...
// //           <p>
// //             Are you hotel staff?{" "}
// //             <Link to="/admin/register" className="font-semibold text-luxe-bronze">
// //               Staff Registration
// //             </Link>
// //           </p>
// //         </div>
